...
def subject(subject):
    ...
    try:
        ...
        app.logger.error(f'Database error in subject: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in subject: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def all_list_by_age(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in all_list_by_age: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in all_list_by_age: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def all_list_by_last_name(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in all_list_by_last_name: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in all_list_by_last_name: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def countries():
    ...
    try:
        ...
        app.logger.error(f'Database error in countries: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in countries: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def countries_wealth_comparison(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in countries_wealth_comparison: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in countries_wealth_comparison: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def countries_born_in(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in countries_born_in: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in countries_born_in: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def countries_life_expectancy(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in countries_life_expectancy: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in countries_life_expectancy: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def industries():
    ...
    try:
        ...
        app.logger.error(f'Database error in industries: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in industries: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def industries_specific_billionaires(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in industries_specific_billionaires: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in industries_specific_billionaires: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def industries_wealth(input):
    ...
    try:
        ...
        app.logger.error(f'Database error in industries_wealth: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in industries_wealth: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q1_bilionarios_eua():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q1_bilionarios_eua: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q1_bilionarios_eua: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q3_regiao_oeste():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q3_regiao_oeste: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q3_regiao_oeste: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q4_genero_feminino():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q4_genero_feminino: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q4_genero_feminino: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q5_cidade_mais_bilionarios():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q5_cidade_mais_bilionarios: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q5_cidade_mais_bilionarios: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q7_mais_50_anos_ranking():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q7_mais_50_anos_ranking: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q7_mais_50_anos_ranking: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q10_cidades_maior_patrimonio():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q10_cidades_maior_patrimonio: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q10_cidades_maior_patrimonio: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q11_tax_bilionarios_pais():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q11_tax_bilionarios_pais: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q11_tax_bilionarios_pais: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
...
def bd_q14_selfmade_education():
    ...
    try:
        ...
        app.logger.error(f'Database error in bd_q14_selfmade_education: {e}')
        return render_template('erro.html', message='Database error occurred.')
    except Exception as e:
        app.logger.error(f'Unexpected error in bd_q14_selfmade_education: {e}')
        return render_template('erro.html', message='An unexpected error occurred.')
